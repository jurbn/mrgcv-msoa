...
class PointEmitter : public Emitter {
    public:
        ...
        virtual Color3f eval(const EmitterQueryRecord &lRec) const {
            // This function assumes that a ray has been traced towards the light source.
            // However, since the probability of randomly sampling a poing in space is 0,
            // its evaluation returns 0.
            return 0.;
        }
